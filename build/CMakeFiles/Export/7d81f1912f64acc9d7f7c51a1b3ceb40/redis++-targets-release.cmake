...
set_target_properties(redis++::redis++ PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libredis++.so.1.3.11"
  IMPORTED_SONAME_RELEASE "libredis++.so.1"
  )

list(APPEND _cmake_import_check_targets redis++::redis++ )
list(APPEND _cmake_import_check_files_for_redis++::redis++ "${_IMPORT_PREFIX}/lib/libredis++.so.1.3.11" )
